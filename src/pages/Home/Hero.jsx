        ...
        <div className="flex flex-col justify-center px-12 hero text-white bg-gradient-to-r from-[#383A4E] to-[#28282F] min-h-screen">
            <div className='max-w-[900px]'>
                ...
                <div className='mt-5 flex gap-5'>
                    <button className='px-6 py-4 text-[15px] hover:bg-[#434760] bg-[#FC7676] transition-color duration-500 rounded-ss-3xl rounded-ee-3xl'>Choose New Friend</button>
                    <button className='px-6 py-4 text-[15px] hover:bg-[#FC7676] bg-transparent border-2 hover:border-[#FC7676] border-[#6F6F75] transition-color duration-500 rounded-ss-3xl rounded-ee-3xl'>Learn More</button>
                </div>
            </div>
        </div>
    );
